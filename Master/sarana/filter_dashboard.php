...
$sts = $_POST['sts'];
if($sts == 'Bersalin'){
$jumlah_klinik_aktif=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%bersalin%'");
$jum_kpaktif=mysqli_fetch_array($jumlah_klinik_aktif);

$jumlah_klinik_pasif=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%bersalin%') src");
$jum_kppasif=mysqli_fetch_array($jumlah_klinik_pasif);

$jumlah_klinik_nakal=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%bersalin%') src");
$jum_kpnakal=mysqli_fetch_array($jumlah_klinik_nakal);

$jumlah_klinik_stop=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%bersalin%'");
$jum_kpstop=mysqli_fetch_array($jumlah_klinik_stop);

$sql_klinik_aktif    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%bersalin%'";
$hasil_klinik_aktif = mysqli_query($conn, $sql_klinik_aktif);
$no_klinik_aktif=1;

$sql_klinik_tenggang    ="SELECT dp.No, dp.Klinik_Pratama, dp.Alamat_Klinik, dp.Penanggung_Jawab, dp.Tgl_Berlaku, dp.Tgl_JatuhTempo, dp.status_io, dp.status_im FROM data_pemohon dp LEFT JOIN tindakan_masa_tenggang tmt ON tmt.Nama_KlinikPratama = dp.Klinik_Pratama WHERE dp.Tgl_JatuhTempo <= '$thn' AND dp.klasifikasi LIKE '%bersalin%' AND tmt.id_tindakan_mt IS NULL ORDER BY No ASC LIMIT 5
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$sql_klinik_tenggang1   ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM data_pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%bersalin%'
";
$hasil_klinik_tenggang1 = mysqli_query($conn, $sql_klinik_tenggang1);
$no_klinik_tenggang=1;
$no_klinik_tenggang1=1;
$sql_klinik_nakal    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%bersalin%'";
$hasil_klinik_nakal  =mysqli_query($conn, $sql_klinik_nakal);
$no_klinik_nakal=1;

$sql_klinik_tutup    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, Keterangan_Pemohon, status_io, status_im FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%bersalin%'";
...
<?php }elseif($sts == 'Kecantikan'){
$jumlah_klinik_aktif=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%kecantikan%'");
$jum_kpaktif=mysqli_fetch_array($jumlah_klinik_aktif);

$jumlah_klinik_pasif=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%kecantikan%') src");
$jum_kppasif=mysqli_fetch_array($jumlah_klinik_pasif);

$jumlah_klinik_nakal=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%kecantikan%') src");
$jum_kpnakal=mysqli_fetch_array($jumlah_klinik_nakal);

$jumlah_klinik_stop=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%kecantikan%'");
$jum_kpstop=mysqli_fetch_array($jumlah_klinik_stop);

$sql_klinik_aktif    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%kecantikan%'";
$hasil_klinik_aktif = mysqli_query($conn, $sql_klinik_aktif);
$no_klinik_aktif=1;

$sql_klinik_tenggang    ="SELECT dp.No, dp.Klinik_Pratama, dp.Alamat_Klinik, dp.Penanggung_Jawab, dp.Tgl_Berlaku, dp.Tgl_JatuhTempo, dp.status_io, dp.status_im FROM data_pemohon dp LEFT JOIN tindakan_masa_tenggang tmt ON tmt.Nama_KlinikPratama = dp.Klinik_Pratama WHERE dp.Tgl_JatuhTempo <= '$thn' AND dp.klasifikasi LIKE '%kecantikan%' AND tmt.id_tindakan_mt IS NULL ORDER BY No ASC LIMIT 5
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$sql_klinik_tenggang1   ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM data_pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%kecantikan%'
";
$hasil_klinik_tenggang1 = mysqli_query($conn, $sql_klinik_tenggang1);
$no_klinik_tenggang=1;
$no_klinik_tenggang1=1;

$sql_klinik_nakal    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%kecantikan%'";
$hasil_klinik_nakal  =mysqli_query($conn, $sql_klinik_nakal);
$no_klinik_nakal=1;

$sql_klinik_tutup    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, Keterangan_Pemohon, status_io, status_im FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%kecantikan%'";
$hasil_klinik_tutup  =mysqli_query($conn, $sql_klinik_tutup);
$no_klinik_tutup=1; ?>
...
<?php }elseif($sts == 'Hemodialisis'){
$jumlah_klinik_aktif=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%hemodialisis%'");
$jum_kpaktif=mysqli_fetch_array($jumlah_klinik_aktif);

$jumlah_klinik_pasif=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%hemodialisis%') src");
$jum_kppasif=mysqli_fetch_array($jumlah_klinik_pasif);

$jumlah_klinik_nakal=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%hemodialisis%') src");
$jum_kpnakal=mysqli_fetch_array($jumlah_klinik_nakal);

$jumlah_klinik_stop=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%hemodialisis%'");
$jum_kpstop=mysqli_fetch_array($jumlah_klinik_stop);

$sql_klinik_aktif    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%hemodialisis%'";
$hasil_klinik_aktif = mysqli_query($conn, $sql_klinik_aktif);
$no_klinik_aktif=1;

$sql_klinik_tenggang    ="SELECT dp.No, dp.Klinik_Pratama, dp.Alamat_Klinik, dp.Penanggung_Jawab, dp.Tgl_Berlaku, dp.Tgl_JatuhTempo, dp.status_io, dp.status_im FROM data_pemohon dp LEFT JOIN tindakan_masa_tenggang tmt ON tmt.Nama_KlinikPratama = dp.Klinik_Pratama WHERE dp.Tgl_JatuhTempo <= '$thn' AND dp.klasifikasi LIKE '%hemodialisis%' AND tmt.id_tindakan_mt IS NULL ORDER BY No ASC LIMIT 5
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$sql_klinik_tenggang1   ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM data_pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%hemodialisis%'
";
$hasil_klinik_tenggang1 = mysqli_query($conn, $sql_klinik_tenggang1);
$no_klinik_tenggang=1;
$no_klinik_tenggang1=1;

$sql_klinik_nakal    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%hemodialisis%'";
$hasil_klinik_nakal  =mysqli_query($conn, $sql_klinik_nakal);
$no_klinik_nakal=1;

$sql_klinik_tutup    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, Keterangan_Pemohon, status_io, status_im FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%hemodialisis%'";
$hasil_klinik_tutup  =mysqli_query($conn, $sql_klinik_tutup);
$no_klinik_tutup=1; ?>
...
<?php }elseif($sts == 'Gigi'){
$jumlah_klinik_aktif=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%gigi%'");
$jum_kpaktif=mysqli_fetch_array($jumlah_klinik_aktif);

$jumlah_klinik_pasif=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%gigi%') src");
$jum_kppasif=mysqli_fetch_array($jumlah_klinik_pasif);

$jumlah_klinik_nakal=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%gigi%') src");
$jum_kpnakal=mysqli_fetch_array($jumlah_klinik_nakal);

$jumlah_klinik_stop=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%gigi%'");
$jum_kpstop=mysqli_fetch_array($jumlah_klinik_stop);

$sql_klinik_aktif    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%gigi%'";
$hasil_klinik_aktif = mysqli_query($conn, $sql_klinik_aktif);
$no_klinik_aktif=1;

$sql_klinik_tenggang    ="SELECT dp.No, dp.Klinik_Pratama, dp.Alamat_Klinik, dp.Penanggung_Jawab, dp.Tgl_Berlaku, dp.Tgl_JatuhTempo, dp.status_io, dp.status_im FROM data_pemohon dp LEFT JOIN tindakan_masa_tenggang tmt ON tmt.Nama_KlinikPratama = dp.Klinik_Pratama WHERE dp.Tgl_JatuhTempo <= '$thn' AND dp.klasifikasi LIKE '%gigi%' AND tmt.id_tindakan_mt IS NULL ORDER BY No ASC LIMIT 5
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$sql_klinik_tenggang1   ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM data_pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%gigi%'
";
$hasil_klinik_tenggang1 = mysqli_query($conn, $sql_klinik_tenggang1);
$no_klinik_tenggang=1;
$no_klinik_tenggang1=1;

$sql_klinik_nakal    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%gigi%'";
$hasil_klinik_nakal  =mysqli_query($conn, $sql_klinik_nakal);
$no_klinik_nakal=1;

$sql_klinik_tutup    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, Keterangan_Pemohon, status_io, status_im FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%gigi%'";
$hasil_klinik_tutup  =mysqli_query($conn, $sql_klinik_tutup);
$no_klinik_tutup=1; ?>
...
<?php }elseif($sts == 'Umum'){
$jumlah_klinik_aktif=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%umum%'");
$jum_kpaktif=mysqli_fetch_array($jumlah_klinik_aktif);

$jumlah_klinik_pasif=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%umum%') src");
$jum_kppasif=mysqli_fetch_array($jumlah_klinik_pasif);

$jumlah_klinik_nakal=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%umum%') src");
$jum_kpnakal=mysqli_fetch_array($jumlah_klinik_nakal);

$jumlah_klinik_stop=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%umum%'");
$jum_kpstop=mysqli_fetch_array($jumlah_klinik_stop);

$sql_klinik_aktif    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%umum%'";
$hasil_klinik_aktif = mysqli_query($conn, $sql_klinik_aktif);
$no_klinik_aktif=1;

$sql_klinik_tenggang    ="SELECT dp.No, dp.Klinik_Pratama, dp.Alamat_Klinik, dp.Penanggung_Jawab, dp.Tgl_Berlaku, dp.Tgl_JatuhTempo, dp.status_io, dp.status_im FROM data_pemohon dp LEFT JOIN tindakan_masa_tenggang tmt ON tmt.Nama_KlinikPratama = dp.Klinik_Pratama WHERE dp.Tgl_JatuhTempo <= '$thn' AND dp.klasifikasi LIKE '%umum%' AND tmt.id_tindakan_mt IS NULL ORDER BY No ASC LIMIT 5
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$sql_klinik_tenggang1   ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM data_pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%umum%'
";
$hasil_klinik_tenggang1 = mysqli_query($conn, $sql_klinik_tenggang1);
$no_klinik_tenggang=1;
$no_klinik_tenggang1=1;

$sql_klinik_nakal    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%umum%'";
$hasil_klinik_nakal  =mysqli_query($conn, $sql_klinik_nakal);
$no_klinik_nakal=1;

$sql_klinik_tutup    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, Keterangan_Pemohon, status_io, status_im FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%umum%'";
$hasil_klinik_tutup  =mysqli_query($conn, $sql_klinik_tutup);
$no_klinik_tutup=1; ?>
...
<?php }elseif($sts == 'Jantung'){
$jumlah_klinik_aktif=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%jantung%'");
$jum_kpaktif=mysqli_fetch_array($jumlah_klinik_aktif);

$jumlah_klinik_pasif=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%jantung%') src");
$jum_kppasif=mysqli_fetch_array($jumlah_klinik_pasif);

$jumlah_klinik_nakal=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%jantung%') src");
$jum_kpnakal=mysqli_fetch_array($jumlah_klinik_nakal);

$jumlah_klinik_stop=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%jantung%'");
$jum_kpstop=mysqli_fetch_array($jumlah_klinik_stop);

$sql_klinik_aktif    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%jantung%'";
$hasil_klinik_aktif = mysqli_query($conn, $sql_klinik_aktif);
$no_klinik_aktif=1;

$sql_klinik_tenggang    ="SELECT dp.No, dp.Klinik_Pratama, dp.Alamat_Klinik, dp.Penanggung_Jawab, dp.Tgl_Berlaku, dp.Tgl_JatuhTempo, dp.status_io, dp.status_im FROM data_pemohon dp LEFT JOIN tindakan_masa_tenggang tmt ON tmt.Nama_KlinikPratama = dp.Klinik_Pratama WHERE dp.Tgl_JatuhTempo <= '$thn' AND dp.klasifikasi LIKE '%jantung%' AND tmt.id_tindakan_mt IS NULL ORDER BY No ASC LIMIT 5
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$sql_klinik_tenggang1   ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM data_pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%jantung%'
";
$hasil_klinik_tenggang1 = mysqli_query($conn, $sql_klinik_tenggang1);
$no_klinik_tenggang=1;
$no_klinik_tenggang1=1;

$sql_klinik_nakal    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%jantung%'";
$hasil_klinik_nakal  =mysqli_query($conn, $sql_klinik_nakal);
$no_klinik_nakal=1;

$sql_klinik_tutup    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, Keterangan_Pemohon, status_io, status_im FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%jantung%'";
$hasil_klinik_tutup  =mysqli_query($conn, $sql_klinik_tutup);
$no_klinik_tutup=1; ?>
...
<?php }elseif($sts == 'Rehabilitasi Medik'){
$jumlah_klinik_aktif=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%rehabilitasi medik%'");
$jum_kpaktif=mysqli_fetch_array($jumlah_klinik_aktif);

$jumlah_klinik_pasif=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%rehabilitasi medik%') src");
$jum_kppasif=mysqli_fetch_array($jumlah_klinik_pasif);

$jumlah_klinik_nakal=mysqli_query($conn, "SELECT COUNT(*) FROM (SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%rehabilitasi medik%') src");
$jum_kpnakal=mysqli_fetch_array($jumlah_klinik_nakal);

$jumlah_klinik_stop=mysqli_query($conn, "SELECT COUNT(Keterangan_Pemohon) FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%rehabilitasi medik%'");
$jum_kpstop=mysqli_fetch_array($jumlah_klinik_stop);

$sql_klinik_aktif    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM `data_pemohon` WHERE Keterangan_Pemohon NOT LIKE '%TUTUP%' AND klasifikasi LIKE '%rehabilitasi medik%'";
$hasil_klinik_aktif = mysqli_query($conn, $sql_klinik_aktif);
$no_klinik_aktif=1;
...
$sql_klinik_nakal    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thnbln' AND klasifikasi LIKE '%rehabilitasi medik%'";
$hasil_klinik_nakal  =mysqli_query($conn, $sql_klinik_nakal);
$no_klinik_nakal=1;

$sql_klinik_tutup    ="SELECT Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, Keterangan_Pemohon, status_io, status_im FROM Data_Pemohon where Keterangan_Pemohon Like '%TUTUP%' AND klasifikasi LIKE '%rehabilitasi medik%'";
$hasil_klinik_tutup  =mysqli_query($conn, $sql_klinik_tutup);
$no_klinik_tutup=1; ?>

...
$orderBy= (isset($_GET['by'])) ?$_GET['by'] : "namasarana1Dokter";
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-1"><a href="<?php $_SERVER['PHP_SELF']?>?by=namasarana1Dokter">Nama Sarana I</th>
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysqli_query($conn, "SELECT * from sdmkdokter order by ".$orderBy);
	}

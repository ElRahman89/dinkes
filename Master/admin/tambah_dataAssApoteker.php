...
$link = mysqli_connect("localhost", "root", "", "sdk") or die($link);
		...
		$namaAssApoteker=mysqli_real_escape_string($link, $_POST['namaAssApoteker']);
		$tempatlahirAssApoteker=$_POST['tempatlahirAssApoteker'];
		$tgllahirAssApoteker=$_POST['tgllahirAssApoteker'];
		$alamatAssApoteker=mysqli_real_escape_string($link, $_POST['alamatAssApoteker']);
		$sipAssApoteker=$_POST['sipAssApoteker'];
		
		$namasaranaAssApoteker=$_POST['namasaranaAssApoteker'];
		$alamatsaranaAssApoteker=mysqli_real_escape_string($link, $_POST['alamatsaranaAssApoteker']);

...
<?php 
$orderBy= (isset($_GET['by'])) ?$_GET['by'] : "namasarana1Doktergg";
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-1"><a href="<?php $_SERVER['PHP_SELF']?>?by=namasarana1Doktergg">Nama Sarana</th>
	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				...
				<a href="editDoktergg.php?No=<?php echo $b['No']; ?>" class="btn btn-warning" name="edit">Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapusDoktergg.php?No=<?php echo $b['No']; ?>' }" class="btn btn-danger" name="hapus">Hapus</a>
			</td>
		</tr>				
		<?php 
	}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Dokter Gigi</h4>
			</div>

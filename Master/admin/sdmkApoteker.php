...
<?php 
$orderBy= (isset($_GET['by'])) ?$_GET['by'] : "namasaranaApoteker";
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-1"><a href="<?php $_SERVER['PHP_SELF']?>?by=namasaranaApoteker">Nama Sarana</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Apoteker</h4>
			</div>

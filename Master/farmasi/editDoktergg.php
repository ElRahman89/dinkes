	...
	<form action="updateDoktergg.php" method="post">
		<table class="table">
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="namasarana1Doktergg" name="namasarana1Doktergg" value="<?php echo $d['namasarana1Doktergg'] ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="namasarana2Doktergg" name="namasarana2Doktergg" value="<?php echo $d['namasarana2Doktergg'] ?>"></td>
			</tr>
			<tr>

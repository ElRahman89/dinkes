	...
	<form action="updateDokter.php" method="post">
		<table class="table">
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="namasarana1Dokter" name="namasarana1Dokter" value="<?php echo $d['namasarana1Dokter'] ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="namasarana2Dokter" name="namasarana2Dokter" value="<?php echo $d['namasarana2Dokter'] ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" class="form-control" id="namasarana3Dokter" name="namasarana3Dokter" value="<?php echo $d['namasarana3Dokter'] ?>"></td>
			</tr>
			<tr>

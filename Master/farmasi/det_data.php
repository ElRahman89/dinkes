...
<a class="btn" href="../farmasi/datapemohonasli.php"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>
...
while($d=mysqli_fetch_array($det)){
	...
	<table class="table">
		...
		<tr>
			<td>Badan_Hukum</td>
			<td>Rp.<?php echo $d['Badan_Hukum'] ?></td>
		</tr>
		<tr>
			<td>Nama_Notaris</td>
			<td>Rp.<?php echo $d['Nama_Notaris'] ?></td>
		</tr>
		<tr>

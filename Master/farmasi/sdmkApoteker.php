...
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-default col-md-2" name="tambahdata" id="tambahdata" disabled><span class="glyphicon glyphicon-plus" disabled></span>Tambah Data</button>
<br/>
<br/>
	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				...
				<a href="editApoteker.php?No=<?php echo $b['No']; ?>" class="btn btn-default" name="edit" disabled>Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapusApoteker.php?No=<?php echo $b['No']; ?>' }" class="btn btn-default" name="hapus" disabled>Hapus</a>
			</td>
		</tr>				
		<?php 
	}

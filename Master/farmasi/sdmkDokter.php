	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				...
				<a href="editDokter.php?No=<?php echo $b['No']; ?>" class="btn btn-default" name="edit" disabled>Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapusDokter.php?No=<?php echo $b['No']; ?>' }" class="btn btn-default" name="hapus" disabled>Hapus</a>
			</td>
		</tr>				
		<?php 
	}

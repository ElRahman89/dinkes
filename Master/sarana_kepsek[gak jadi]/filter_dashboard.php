...
$sql_klinik_tenggang    ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%bersalin%'
";
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div id="klinik_tenggang" class="collapse">
                        <h2>Daftar Klinik Masuk Masa Tenggang</h2>
...
$sql_klinik_tenggang    ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%kecantikan%'
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$no_klinik_tenggang=1;
...
$sql_klinik_tenggang    ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%hemodialisis%'
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$no_klinik_tenggang=1;
...
$sql_klinik_tenggang    ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%gigi%'
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$no_klinik_tenggang=1;
...
$sql_klinik_tenggang    ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%umum%'
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$no_klinik_tenggang=1;
...
$sql_klinik_tenggang    ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%jantung%'
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$no_klinik_tenggang=1;
...
$sql_klinik_tenggang    ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn' AND klasifikasi LIKE '%Rehabilitasi Medik%'
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$no_klinik_tenggang=1;
...
$sql_klinik_tenggang    ="SELECT No, Klinik_Pratama, Alamat_Klinik, Penanggung_Jawab, Tgl_Berlaku, Tgl_JatuhTempo, status_io, status_im FROM Data_Pemohon WHERE Tgl_JatuhTempo <= '$thn'
";
$hasil_klinik_tenggang = mysqli_query($conn, $sql_klinik_tenggang);
$no_klinik_tenggang=1;

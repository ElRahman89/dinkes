...
$link = mysqli_connect("localhost", "root", "", "sdk") or die($link);
		...
		$Nama_Bidan=mysqli_real_escape_string($link, $_POST['Nama_Bidan']);
		$tlBidan=$_POST['tlBidan'];
		$tglBidan=$_POST['tglBidan'];
		$alamatBidan= mysqli_real_escape_string($link, $_POST['alamatBidan']);
		$kotaBidan=$_POST['kotaBidan'];
		$nomorstrBidan=$_POST['nomorstrBidan'];
		$namasaranaBidan=$_POST['namasaranaBidan'];
		$alamatsaranaBidan=mysqli_real_escape_string($link, $_POST['alamatsaranaBidan']);

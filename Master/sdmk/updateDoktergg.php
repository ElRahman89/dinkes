...
$No=$_POST['No'];
$namaDoktergg=mysqli_real_escape_string($conn, $_POST['namaDoktergg']);
$tempatlahirDoktergg=$_POST['tempatlahirDoktergg'];
$tgllahirDoktergg=$_POST['tgllahirDoktergg'];
$alamatDoktergg=mysqli_real_escape_string($conn, $_POST['alamatDoktergg']);
$sip1Doktergg=$_POST['sip1Doktergg'];
$namasarana1Doktergg=$_POST['namasarana1Doktergg'];
$alamatsarana1Doktergg=mysqli_real_escape_string($conn, $_POST['alamatsarana1Doktergg']);
$tglcetak1Doktergg=$_POST['tglcetak1Doktergg'];
$sip2Doktergg=$_POST['sip2Doktergg'];
$namasarana2Doktergg=$_POST['namasarana2Doktergg'];
$alamatsarana2Doktergg=mysqli_real_escape_string($conn, $_POST['alamatsarana2Doktergg']);

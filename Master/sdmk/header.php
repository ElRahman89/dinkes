...
<body>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			<li class="active"><a href="fixExport.php"><span class="glyphicon glyphicon-home"></span>  Dashboard</a></li>			
			<li><a href="datapemohonasli.php" name="databarang"><span class="glyphicon glyphicon-briefcase"></span>Data Sarana</a>

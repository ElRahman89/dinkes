...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Pemohon Asli</h3>
	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				...
				<a href="edit_data.php?No=<?php echo $b['No']; ?>" class="btn btn-default" name="edit" disabled>Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_data.php?No=<?php echo $b['No']; ?>' }" class="btn btn-default" name="hapus" disabled>Hapus</a>
			</td>
		</tr>				
		<?php 
	}
			...
			<div class="modal-body">
				<form onsubmit="return validasi()" action="tambah_data.php" method="post">
					...
					<div class="form-group">
						...
						<input name="Tgl_IzinLingkungan" id="Tgl_IzinLingkungan" type="text" class="form-control" placeholder="Tgl_IzinLingkungan">
					</div>
					<div class="form-group">

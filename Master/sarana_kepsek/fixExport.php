...
<html>
     <head>
        <title>PENCARIAN DATA KLINIK</title>
...
<div id="search" class="container">
  <h1 style="color:black; font-weight: 750;" align="center">Pencarian Informasi Data Klinik</h1><br />
  <br />
    <form name="form_search" action="" method="post" class="form-inline">
      <div class="form-group">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <h4 style="color: black; font-weight: 750;">Cari berdasarkan Nama Klinik</h4>      
      &nbsp;&nbsp;&nbsp;
        <input style="height: 50px; width:955px" type="text" name="search_text" id="search_text" placeholder="Tuliskan Nama Klinik" class="form-control">
...
<!-- <button type="button" class="btn btn-default btn-md" style="border:0px; margin-left: 90%;" onclick="tbex(['tbl1','tbl2','tbl3','tbl4','tbl5','tbl6','tbl7'], ['Data Dokter','Data Dokter Gigi','Data Perawat','Data Bidan','Data Apoteker', 'Data Asisten Apoteker', 'Data ATLM'],'TestBook.xls', 'Excel')">
          <a href="#" style="text-decoration: none;">
          <span class="glyphicon glyphicon-print"></span> Export </a>
</button> -->
<!-- <button type="button" class="btn btn-default btn-md" style="border:0px; margin-left: 90%;" onclick="tes()">
          <a href="#" style="text-decoration: none;">
          <span class="glyphicon glyphicon-print"></span> Tes </a>
</button> -->

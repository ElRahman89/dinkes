...
<html>  
    <head>  
        <title>Data Pengawasan Izin Mendirikan</title>  
    ...
    <body>  
        <div class="container">
			...
			<h3 align="center">Data Pengawasan Izin Mendirikan</a></h3><br />
			<br />
			<br />
			<div align="right" style="margin-bottom:5px;">
				<button type="button" name="add" id="add" class="btn btn-success btn-xs">Add</button>
				<a href="../lihat_data2.php"><button data-toggle="modal" class="btn btn-info btn-xs">Lihat Data</button></a>
			...
			<div id="content">
	          <div >
	            <h4>PERATURAN DAN KEBIJAKAN PERIZINAN MENDIRIKAN KLINIK</h4>
	            <h5 style="color: red">*Harap diperhatikan</h5>
	            <h5>Dalam proses pengawasan Izin Mendirikan klinik terdapat beberapa peraturan wajib yang harus diketahui sebelumnya :</h5> <br />
	          </div>

...
<div class="input-group col-md-5 col-md-offset-7">
		...
		<select class="form-control" name="thn" onchange="getgraf(this.value)">
			...
			<?php 
			$sql=mysqli_query($conn, "SELECT YEAR(tgl_tindakan_hv) as thn from tindakan_hasil_visitasi ORDER BY tgl_tindakan_hv ASC");
...
<table class="table table-hover">
	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td><button class="btn btn-md btn-warning" data-toggle="modal" data-target="#tdk<?php echo $idhv;?>"><i class="fa fa-edit"></i> Ubah Data</button>

	...
	while($b=mysqli_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				...
				<a disabled href="datapemohon_edit.php?No=<?php echo $b['No']; ?>" class="btn btn-warning" name="edit">Edit</a>
				...
				<a disabled href="cetak_barang.php?No=<?php echo $b['No']; ?>" target="_blank" class="btn btn-success" name="cetak">cetak</a>

...
<html>
     ...
     <body>
     <button type="button" class="btn btn-default btn-lg" style="border:0px">
          <a href="index.php" style="text-decoration: none">
          <span class="glyphicon glyphicon-home"></span> Home </a>
        </button>
<div id="search" class="container">
  <h1 style="color: #0066ff; font-weight: 750;" align="center">Pencarian Informasi data Klinik</h1><br />
  <br />
    <form name="form_search" action="" method="post" class="form-inline">
      <div class="form-group">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input style="height: 50px; width:815px" type="text" name="search_text" id="search_text" placeholder="Tuliskan Nama Klinik" class="form-control">
  ...
  <div id="hasil_search" display:"block" class="container" style="margin-left: -20px; width:1080px; ">
  <?php
  if(isset($_POST['search'])){
...
echo   '     <h4 class="panel-tittle">';
echo     '       <a href="#'.$row["idKlinik"].'" data-toggle="collapse" data-parent="#posts">'.$row["namaKlinik"].'</a>';
echo      '  </h4>';
echo      '</div>';
...
<h4 class="panel-title">
  <a data-toggle="collapse" data-parent="#accordion1" href="#inside1">Keterangan Klinik</a>
</h4>
</div>
...
echo '<div class="panel">
  <div class="panel-heading">
<h4 class="panel-title">
<a data-toggle="collapse" data-parent="#accordion1" href="#inside2">Sarana&Prasarana Klinik</a>
</h4>
</div>
...
echo '<div class="panel">
  <div class="panel-heading">
<h4 class="panel-title">
<a data-toggle="collapse" data-parent="#accordion1" href="#inside3">SDM Klinik</a>
</h4>
</div>
<div id="inside3" class="panel-collapse collapse">';
echo '<button onclick="tablesToExcel([' .'tbl1'. ',' .'tbl2'.'],' .'Test.xls'. ',' .'Excel'.')">Export to Excel</button>
  <div class="panel-body">';
...
echo '<br/>';
  ...
  echo'   </div>';
    ...
    ?>
<button onclick="tablesToExcel(['tbl1','tbl2','tbl3','tbl4','tbl5','tbl6','tbl7'], ['Data Dokter','Data Dokter Gigi','Data Perawat','Data Bidan','Data Apoteker', 'Data Asisten Apoteker', 'Data ATLM'],'TestBook.xls', 'Excel')">Export to Excel</button>
</div>
</div>
</div>
</div>

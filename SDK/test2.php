...
<button  onclick="tablesToExcel(['tbl1','tbl2','tbl3','tbl4','tbl5','tbl6','tbl7'], ['ProductDay1','ProductDay2','ProductDay3','ProductDay4','ProductDay5','ProductDay6','ProductDay7'], 'TestBook.xls', 'Excel')">Export to Excel</button>
